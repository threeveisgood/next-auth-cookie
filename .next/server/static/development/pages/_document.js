...
const authInitialProps = isProtectedRoute => ({
  ...
  const isAnonymous = !user || user.type !== "auth";
...
const logoutUser = async () => {
  ...
  await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/api/logout");
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  render() {
    ...
    return __jsx("html", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Main"], null), __jsx("script", {
      dangerouslySetInnerHTML: {
